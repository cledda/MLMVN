...
Results = MLMVN('sizeOfMlmvn', [2 1], 'inputs', Learn, 'stoppingCriteria', 'rmse', 'discreteInput', 1, 'discreteOutput', 1, 'globalthresholdvalue', 0, 'localThresholdValue', 0, 'SoftMargins', 1, 'angularGlobalThresholdValue', 0.001, 'angularLocalThresholdValue', 0,'initialWeights','random', 'numberOfSectors', 64);
